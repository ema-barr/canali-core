...
import edu.ucla.cs.scai.canali.core.index.tokens.*;
 ...
 */
public class BuildGeneralKBIndex {
    ...
    public BuildGeneralKBIndex(String basePathInput, String basePathOutput) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args != null && args.length == 2) {
            ...
            fn1 = "/home/lucia/nlp2sparql-data/dbpedia-processed/2015-10/supportFiles/";
            fn2 = "/home/lucia/nlp2sparql-data/dbpedia-processed/2015-10/index/";
        }
        long start = System.currentTimeMillis();
        System.out.println("Started at " + new Date());
        new BuildGeneralKBIndex(fn1, fn2).start();
