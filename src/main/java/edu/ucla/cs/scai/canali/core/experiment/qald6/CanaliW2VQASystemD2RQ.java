...
import di.uniba.it.nlpita.vectors.*;
 ...
 */
public class CanaliW2VQASystemD2RQ implements QASystem {
	...
	public CanaliW2VQASystemD2RQ(String word2vecModelPath, String propertyLabesPath) throws Exception {
